...
- **QUICK_TEST_GUIDE.md** - 빠른 테스트 가이드 (Swagger UI 사용법 포함)
...
2. **QUICK_TEST_GUIDE.md** - Swagger UI로 API 테스트

### API 사용하기 (10분)

1. **FINAL_API_SPEC.md** - API 스펙 확인
2. **API_DOCUMENTATION.md** - 상세 API 문서
